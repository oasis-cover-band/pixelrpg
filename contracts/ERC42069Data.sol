...
// gd (GAME DATA)
    ...
    // 0 == HEALTH REPLENISH POTION?
    // 1 == ENERGY REPLENISH POTION?
    // 2 == STRENGTH POTION?
    // 3 == DEXTERITY POTION?
    // 4 == INTELLIGENCE POTION?
    // 5 == CHARISMA POTION?
    // 6 == HEALTH BOOST POTION?
    // 7 == ENERGY BOOST POTION?
    // 8 == BREED REPLENISH POTION?
    // ***************************************
    //  ** IMPORTANT IDENTIFIERS END **
...
// 
    ...
    // MAXCONSUMABLEHEALTH (CAP OF HEALTH A CONSUMABLE CAN GIVE) // 20
    // MAXCONSUMABLEENERGY (CAP OF ENERGY A CONSUMABLE CAN GIVE) // 20
    // MAXCONSUMABLESTATS (CAP OF A SINGLE STAT A CONSUMABLE CAN GIVE) // 5
...
// COSTS
// 
    // ITEMCOST (COST TO GENERATE A RANDOM NFT ITEM (TYPE 3)) 500 (ERC20CREDITS)
