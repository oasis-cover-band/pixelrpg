...
// WORLD
// 
    // CITYBLOCKROWSIZE (AMOUNT OF PLOTS OF LAND IN AN AREA ROW) // 16 
    // REGIONSIZE (TOTAL AMOUNT OF PLOTS OF LAND IN AN AREA) // 256 
    // NUMBEROFREGIONS (AMOUNT OF AREAS IN THE WORLD) // 4096