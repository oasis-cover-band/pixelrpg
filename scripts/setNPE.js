...
async function setEnemies(area) {
    if (area === 0) {
      ...
      await contracts[9].setEnemies(area, 1, 0, {gasLimit: 9143818});
      if (area % 4 === 0) {
      await contracts[9].setEnemies(area, 1, 0, {gasLimit: 9143818});
      }
      if (area % 8 === 0) {
      ...
      await contracts[9].setEnemies(area, 2, 0, {gasLimit: 9143818});
      if (area % 4 === 0) {
      await contracts[9].setEnemies(area, 2, 0, {gasLimit: 9143818});
      }
      if (area % 8 === 0) {
      ...
      await contracts[9].setEnemies(area, 3, 0, {gasLimit: 9143818});
      if (area % 4 === 0) {
        await contracts[9].setEnemies(area, 3, 0, {gasLimit: 9143818});
      }
      if (area % 8 === 0) {
